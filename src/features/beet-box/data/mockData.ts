...
export const SOPS: SOP[] = [
  // ── Work Orders ────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      { id: "s01-4", number: 4, instruction: "Set Priority to Routine, Urgent, or AOG. AOG triggers elevated visibility across the system.", warning: "AOG priority should only be used when the aircraft is actually grounded and awaiting return to service. Misuse degrades the urgency signal for the team." },
      { id: "s01-5", number: 5, instruction: "Enter the meter reading at open (Hobbs or tach time). This is recorded for compliance tracking and logbook reference." },
      { id: "s01-6", number: 6, instruction: "Optionally add a description and any general notes. The description appears on the WO card in the dashboard view." },
      { id: "s01-7", number: 7, instruction: "Click 'Create Work Order'. The system generates a WO number (WO-YYYY-NNNN) and opens the detail view in Draft status." },
  ...
  // ── Safety ─────────────────────────────────────────────────────────────────
  {
    ...
    author: "Jonathan Schaedig",
    approvedBy: "Jonathan Schaedig",
    description: "Procedures for creating and managing Aircraft on Ground (AOG) priority work orders, including expedited parts sourcing and status communication.",
    tags: ["AOG", "priority", "grounded", "expedite"],
    relatedSOPs: ["sop-01", "sop-08"],
    steps: [
      { id: "s15-1", number: 1, instruction: "Create the work order with Priority set to 'AOG'. This triggers a red priority badge visible in all dashboard views." },
