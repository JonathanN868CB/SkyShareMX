...
// (the others are records-vault-register and records-vault-rasterize-background).
// S3 is an ingest-staging area only — once the rasterizer mirrors the PDF to
// Supabase Storage, every other retrieval path reads exclusively from Supabase.
//
